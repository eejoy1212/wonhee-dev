    ...
    <main className="font-sans">
        ...
        {menuOpen && (
          <div className="md:hidden bg-black/60 backdrop-blur-md text-white absolute top-[80px] left-0 w-full z-[998] px-6 py-4">
            <ul className="flex flex-col gap-4 font-medium text-[20px]">
              {["ABOUT ME", "SKILLS", "BLOG", "PROJECTS"].map(
                (label, index) => (
                  <li
                    key={label}
                    className={`border-${
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col justify-start items-start gap-3">
            <div className="flex flex-row gap-6 items-center">
              <User />
              <span className="text-2xl">이원희</span>
            </div>
            <div className="flex flex-row gap-6 items-center">
              <Calendar />
              <span className="text-2xl">96.01.14</span>
            </div>
            <div className="flex flex-row gap-6 items-center">
              <MapPin />
              <span className="text-2xl">경기도 수원시</span>
            </div>
            <div className="flex flex-row gap-6 items-center">
              <Phone />
              <span className="text-2xl">010-7596-6578</span>
            </div>
            <div className="flex flex-row gap-6 items-center">
              <Mail />
              <span className="text-2xl">lwh961212@gmail.com</span>
            </div>
            <div className="flex flex-row gap-6 items-center">
              <GraduationCap />
              <span className="text-2xl">명지대학교 자연캠퍼스</span>
            </div>
          </div>
        </div>
      </LandingSection>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          <Card className="w-full  shadow-lg md:rounded-lg">
            ...
            <CardContent>
              <Link
                href={"https://github.com/eejoy1212"}
                className="text-blue-500 text-2xl"
              >
                github.com/eejoy1212
              </Link>
            </CardContent>
          ...
          <Card className="w-full  shadow-lg rounded-lg">
            ...
            <CardContent>
              <Link
                href={"https://www.linkedin.com/in/원희-이-4370a1253"}
                className="text-blue-500 text-2xl"
              >
                linkedin.com/wonheelee
              </Link>
            </CardContent>
            <CardFooter className="mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          ...
          <Card className="w-full h-[400px] shadow-lg rounded-lg">
            <CardContent className="p-0 m-0">
              <Link
                href={
                  "https://nettle-eyeliner-eeb.notion.site/143fc43a156481a38ad4ce9cf94c6346?pvs=4"
                }
                className="text-blue-500 text-2xl"
              >
                <div className="relative w-auto h-[300px] m-[20px] ">
          ...
          <Card className="w-full h-[400px] shadow-lg rounded-lg">
            <CardContent className="p-0 m-0">
              <Link
                href={
                  "http://misodak-admin.s3-website.ap-northeast-2.amazonaws.com/hospital"
                }
                className="text-blue-500 text-2xl"
              >
                <div className="relative w-auto h-[300px] m-[20px] ">
